...
extern char* Encode(void* p0, int p1);

/* Return type for DecodeAlphabet */
struct DecodeAlphabet_return {
	void* r0;
	int r1;
};
...
extern struct DecodeAlphabet_return DecodeAlphabet(char* p0, char* p1);

// EncodeAlphabet encodes a byte slice to a modified base58 string, using alphabet

extern char* EncodeAlphabet(void* p0, int p1, char* p2);
